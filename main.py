...
from transform import AutoModelForSequenceClassification, AutoTokenizer

from utils.corpusutils import Corpus, CorpusPreProcess, Document
...
def load_models(path):
    ...
    with open(os.path.join(path, "lda_models.pkl"), "rb") as model:
        lda_model, vectorizer, lda_topic_dict = pickle.load(models)


def load_corpus(root, setting={}):
